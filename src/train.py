...
train.py
========
Training loop: reads configs/training_config.yaml, trains the model,
logs JSON-lines metrics to stdout, saves the best checkpoint, and supports
early stopping.
"""
...
def main():
    # Look for the config in the mounted path first (Docker/K8s), fall back
    # to the local repo path when running directly on your machine.
